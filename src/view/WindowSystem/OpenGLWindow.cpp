...
void View::OpenGL::OpenGLWindow::startFrame()
{
    glfwPollEvents();
...
void View::OpenGL::OpenGLWindow::endFrame()
{
...
void View::OpenGL::OpenGLWindow::renderWindow()
{
}

void View::OpenGL::OpenGLWindow::createWindow()
{
}

bool View::OpenGL::OpenGLWindow::isOpen()
{
